<div class="row justify-content-center ">
       <div class="card col-12 col-sm-10 col-md-7 col-lg-5 col-xl-7 mt-4">
           ...
           <div class="card-body">
               <form action="index.php?controller=Doctor&action=save" method="POST" class="form">
                    <div class="form-row">
                        <div class="col">
                    ...
                    <div class="form row">
                        <div class="col">
                            ...
                            <input type="number" name="Documento" class="form-control" placeholder="0000000" required>
                        </div>  
                        <div class="col">
                            <br><label for="">Numero de Celular</label>
                            <input type="number" name="Numero" class="form-control" placeholder="0000000" required>
                        </div>          
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <br><label for="dir">Profesion</label>
                            <input type="text" name="Documento" class="form-control" placeholder="Psicolog@" required>
                        </div>  
                        <div class="col">
